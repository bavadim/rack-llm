...
def final_artifacts() -> list[Path]:
    names = [
        ...
        "012_hard_runtime_benchmark_failure.md",
        "012_ours_soft_generation_raw.jsonl",
        "012_soft_real_raw.jsonl",
        "012_soft_real_summary.csv",
        "012_soft_real_risk_coverage.csv",
        "012_soft_candidate_pool.jsonl",
        "012_soft_candidate_pool.raw.jsonl",
        "012_soft_ifbench_rules_audited.jsonl",
        "012_soft_rule_audit.csv",
        "012_soft_rule_audit_failures.md",
